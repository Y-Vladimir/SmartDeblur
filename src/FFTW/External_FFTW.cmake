...
if(USE_SYSTEM_FFTW)
  ...
  set(FFTW_LIBRARIES ${FFTW_LIBDIR}${CMAKE_STATIC_LIBRARY_PREFIX}fftw3${CMAKE_STATIC_LIBRARY_SUFFIX}
	${FFTW_LIBDIR}${CMAKE_STATIC_LIBRARY_PREFIX}fftw3_threads${CMAKE_STATIC_LIBRARY_SUFFIX})
else()
